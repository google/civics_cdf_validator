...
valid_office_role_values = {
    ...
    "lower house", "mayor", "parks", "president", "probate court at law",
    "prosecutor", "public administrator", "public defender", "referenda",
    "register deeds", "registrar of voters", "sanitation",
    "secretary agriculture", "secretary education", "secretary insurance",
    "secretary labor", "secretary land", "secretary state", "school board",
    "sheriff", "solicitor general", "state board education", "state executive",
    "state lower house", "state tribal relations", "state upper house",
    "subcounty executive", "superior clerk", "superior court", "tax court",
    "taxes", "treasurer", "upper house", "utilities", "vice president", "water",
